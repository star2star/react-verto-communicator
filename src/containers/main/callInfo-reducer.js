  ...
  switch (action.type) {
    ...
    case 'CONFERENCE_DATA':
      ...
      if (state.activeCalls[action.data.callId]) {
        oStateReturn.activeCalls[action.data.callId].conferenceData = {
          messages: [],
          ...oStateReturn.activeCalls[action.data.callId].conferenceData,
          ...action.data,
        };
    ...
    case 'RECEIVED_CHAT_MESSAGE':
      ...
      if (
        oStateReturn.activeCalls[action.data.callID] &&
        oStateReturn.activeCalls[action.data.callID].conferenceData
      ) {
        // ok have conference
        ...
        oStateReturn.activeCalls[
          action.data.callID
        ].conferenceData.messages = oStateReturn.activeCalls[
          action.data.callID
        ].conferenceData.messages.concat(action.data);
