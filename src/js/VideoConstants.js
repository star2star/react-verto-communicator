...
VideoConstants.CONF_CMDS={
  ...
  SETLAYER: {name: 'setLayer', functionName: 'modCommand', parameters: ['const:vid-layer', 'layout', 'canvasId']},
  NEXTLAYER: {name: 'nextLayer', functionName: 'modCommand', parameters: ['const:vid-layer', 'layout', 'const:next']},
  PREVLAYER: {name: 'previousLayer', functionName: 'modCommand', parameters: ['const:vid-layer', 'layout', 'const:prev']},
