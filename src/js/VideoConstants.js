...
VideoConstants.CONF_CMDS = {
  ...
  RESETBANNER: {
    name: 'resetBanner',
    functionName: 'banner',
    parameters: ['memberid', 'const:reset'],
  },
  SETLAYOUT: {
    name: 'setLayout',
    functionName: 'setVideoLayout',
    parameters: ['layout', 'canvasId'],
  },
  SETLAYER: {
    name: 'setLayer',
    functionName: 'modCommand',
    parameters: ['const:vid-layer', 'memberid', 'layoutPositionNbrString'],
  },
  NEXTLAYER: {
    name: 'nextLayer',
    functionName: 'modCommand',
    parameters: ['const:vid-layer', 'memberid', 'const:next'],
  },
  PREVLAYER: {
    name: 'previousLayer',
    functionName: 'modCommand',
    parameters: ['const:vid-layer', 'memberid', 'const:prev'],
  },
